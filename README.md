...
pixi add exactextract
# for installing globally
pixi global install exactextract
```
...
It is possible to list all of the versions of `exactextract` available on your platform:
...
```
pixi search exactextract --channel conda-forge
```
